...
enum class RouterDomain(val description: String) {
    ANDROID_INTELLIGENCE("Local Android device operations: diagnostics, files, apps, system analysis"),
    DESKTOP_EXPLOIT("Remote desktop HID control: keyboard/mouse injection, automation workflows"),
    WEB_INTELLIGENCE("Internet content operations: web scraping, API calls, online data gathering"),
